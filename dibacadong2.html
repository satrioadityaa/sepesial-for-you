...
<body>
   ...
   <!-- Watermark Section: Add this to show the watermark -->
   <div id="watermark" style="position: fixed; bottom: 10px; right: 10px; font-size: 24px; font-family: 'Nerko One', sans-serif; color: white; background-color: black; padding: 5px 10px; opacity: 0.7; z-index: 9999; border-radius: 10px;">
      satrio_adty
   </div>
